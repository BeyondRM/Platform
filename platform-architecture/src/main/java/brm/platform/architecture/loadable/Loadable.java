...
abstract public class Loadable {
  ...
  /**
   * Before initialization loading. Count the possible items to be loaded. Typical method implementation includes:
   * <ul>
  ...
  /**
   * During initialization loading. Load each object into the collection, parsing if necessary.
   * <p>
  ...
  /**
   * Finish initialization loading. Typical method implementation includes:
   * <ul>
  ...
  /**
   * Perform validation. This is usable post-loading, to verify that all objects and values are within expected norms.
   * <p>
